...
export function WorkflowModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-2xs z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden border border-slate-200 dark:border-slate-800 animate-in fade-in zoom-in-95 duration-150">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-slate-100 dark:border-slate-800 bg-slate-50/70 dark:bg-slate-950">
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="bg-slate-50 dark:bg-slate-800/60 p-3.5 rounded-xl border border-slate-200/80 dark:border-slate-700 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <Building2 className="w-4 h-4 text-indigo-600 dark:text-indigo-400 shrink-0" />
              <div>
                <p className="text-xs font-bold text-slate-900 dark:text-white">{row.iglesia_nombre}</p>
                <p className="text-[11px] text-slate-500 dark:text-slate-400">
                  Pastor: {row.nombre_pastor || "No asignado"}
                </p>
              </div>
            </div>
            <div className="flex items-center gap-1.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 px-2.5 py-1 rounded-lg text-xs font-semibold text-slate-700 dark:text-slate-300">
          ...
          <div>
            ...
            <div className="grid grid-cols-5 gap-1.5 text-center">
              ...
              <div
                className={`p-2 rounded-lg border text-[10px] font-bold flex flex-col items-center gap-1 ${
                  currentEstado === "borrador"
                    ? "bg-slate-100 dark:bg-slate-800 border-slate-400 dark:border-slate-600 text-slate-800 dark:text-slate-200 ring-2 ring-slate-400/20"
                    : "bg-slate-50 dark:bg-slate-850 border-slate-200 dark:border-slate-800 text-slate-400 dark:text-slate-600"
                }`}
              >
              ...
              <div
                className={`p-2 rounded-lg border text-[10px] font-bold flex flex-col items-center gap-1 ${
                  currentEstado === "enviado"
                    ? "bg-indigo-50 dark:bg-indigo-950/60 border-indigo-400 dark:border-indigo-600 text-indigo-800 dark:text-indigo-300 ring-2 ring-indigo-400/20"
              ...
              <div
                className={`p-2 rounded-lg border text-[10px] font-bold flex flex-col items-center gap-1 ${
                  currentEstado === "en_revision"
                    ? "bg-amber-50 dark:bg-amber-950/60 border-amber-400 dark:border-amber-600 text-amber-800 dark:text-amber-300 ring-2 ring-amber-400/20"
              ...
              <div
                className={`p-2 rounded-lg border text-[10px] font-bold flex flex-col items-center gap-1 ${
                  currentEstado === "aprobado"
                    ? "bg-emerald-50 dark:bg-emerald-950/60 border-emerald-500 dark:border-emerald-600 text-emerald-800 dark:text-emerald-300 ring-2 ring-emerald-500/20"
                    : currentEstado === "consolidado"
                    ? "bg-emerald-50 dark:bg-emerald-950/60 border-emerald-300 dark:border-emerald-700 text-emerald-700 dark:text-emerald-300"
                    : "bg-slate-50 dark:bg-slate-850 border-slate-200 dark:border-slate-800 text-slate-400 dark:text-slate-600"
                }`}
              ...
              <div
                className={`p-2 rounded-lg border text-[10px] font-bold flex flex-col items-center gap-1 ${
                  currentEstado === "consolidado"
                    ? "bg-purple-50 dark:bg-purple-950/60 border-purple-500 dark:border-purple-600 text-purple-800 dark:text-purple-300 ring-2 ring-purple-500/20"
                    : "bg-slate-50 dark:bg-slate-850 border-slate-200 dark:border-slate-800 text-slate-400 dark:text-slate-600"
                }`}
              >
          ...
          {/* Audit Metadata */}
          {row.informe_meta && (
            <div className="bg-slate-50/80 dark:bg-slate-800/60 p-3 rounded-xl border border-slate-100 dark:border-slate-700 text-[11px] space-y-1 text-slate-600 dark:text-slate-400">
          ...
          {/* Observaciones Input */}
          <div>
            <label className="block text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1 flex items-center gap-1">
            ...
            <textarea
              ...
              className="w-full px-3 py-2 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-xl text-xs text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-indigo-600"
            />
          </div>
          ...
          <div className="pt-2 border-t border-slate-100 dark:border-slate-800 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <button
                ...
                className="flex items-center justify-center gap-1.5 px-3 py-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 border border-slate-300 dark:border-slate-700 disabled:opacity-40 text-slate-700 dark:text-slate-300 rounded-xl text-xs font-bold transition cursor-pointer active:scale-95"
              >
